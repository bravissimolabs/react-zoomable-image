...
var _appendImportantToEachValue = __webpack_require__(32);
...
var _getStateKey = __webpack_require__(23);
...
var _isPrefixedProperty = __webpack_require__(36);
...
var _removeNestedStylesPlugin = __webpack_require__(67);
...
var _resolveMediaQueriesPlugin = __webpack_require__(70);

var _resolveMediaQueriesPlugin2 = _interopRequireDefault(_resolveMediaQueriesPlugin);

var _visitedPlugin = __webpack_require__(71);
...
var magPlus = __webpack_require__(80);
var magMinus = __webpack_require__(81);
...
var ZoomableImage = function (_Component) {
  ...
  function ZoomableImage(props) {
    ...
    _this.startZoom = function (initialFocalPoint, isTouchDevice) {
      if (!(0, _lodash.isEqual)(_this.state.viewWindowPosition, initialFocalPoint)) {
        ...
        var defaultZoomLevel = _this.state.defaultZoomLevel;


        var startingFocus = isTouchDevice ? initialFocalPoint.map(function (p) {
          return p * defaultZoomLevel * (largeWidth / width);
        }) : initialFocalPoint;
    ...
    _this.addBodyClickHandlers = function () {
      if (document && document.querySelector) {
        _this.state.bodyClickHandlers.forEach(function (handler) {
          var _document$querySelect;

          (_document$querySelect = document.querySelector('body')).addEventListener.apply(_document$querySelect, _toConsumableArray(handler));
        });
      }
    };
    ...
    _this.removeBodyClickHandlers = function () {
      if (document && document.querySelector) {
        _this.state.bodyClickHandlers.forEach(function (handler) {
          ...
          (_document$querySelect2 = document.querySelector('body')).removeEventListener.apply(_document$querySelect2, _toConsumableArray(handler));
        });
      }
    };
    ...
    _this.calcBackgroundOffsetFromDrag = function (e) {
      ...
      if (e.targetTouches) {
        ...
        var newFocus = (0, _lodash.zipWith)(viewWindowPosition, currentDragPosition, previousDragPosition, function (f, c, p) {
          return f + (p - c);
        });
    ...
    _this.zoom = function (delta) {
      _this.pauseZoom();
      var zoomLevel = Math.round((_this.state.zoomLevel + delta) * 10) / 10;
    ...
    _this.state = {
      ...
      pageClickHandlersAreAdded: false,
      transitionZoomBackground: true,
      bodyClickHandlers: [['click', _this.endZoom], ['touchstart', _this.checkForTap], ['touchend', _this.onTouchEnd]]
    };
    return _this;
  }
  ...
  _createClass(ZoomableImage, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          style: [styles.wrapper, { width: width, height: height, cursor: 'url(' + (zoomed ? magMinus : magPlus) + '), pointer' }],
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            style: [styles.zoomContainer, { width: width, height: height, zIndex: zoomed * 100 }]
          },
          displayMap && _react2.default.createElement(
            ...
            _react2.default.createElement('img', { style: styles.innerMapImage, src: thumbnailImage.src, alt: 'thumbnail' }),
            _react2.default.createElement('div', {
              style: [styles.innerMapHighlightBox, {
...
ZoomableImage.propTypes = {
  baseImage: _propTypes2.default.shape(imageShape).isRequired,
  displayMap: _propTypes2.default.bool,
  largeImage: _propTypes2.default.shape(imageShape).isRequired,
  mapBorderColor: _propTypes2.default.string,
  thumbnailImage: _propTypes2.default.shape(imageShape).isRequired,
...
exports.default = (0, _radium2.default)(ZoomableImage);
...
var _styleRoot = __webpack_require__(74);
...
var _prefixAll2 = __webpack_require__(35);

var _prefixAll3 = _interopRequireDefault(_prefixAll2);

var _getBrowserInformation = __webpack_require__(46);
...
var _sortPrefixedStyle = __webpack_require__(20);
...
var _calc = __webpack_require__(52);

var _calc2 = _interopRequireDefault(_calc);

var _zoomCursor = __webpack_require__(53);

var _zoomCursor2 = _interopRequireDefault(_zoomCursor);

var _grabCursor = __webpack_require__(54);

var _grabCursor2 = _interopRequireDefault(_grabCursor);

var _flex = __webpack_require__(55);
...
var _gradient = __webpack_require__(57);
...
var _flexboxIE = __webpack_require__(60);

var _flexboxIE2 = _interopRequireDefault(_flexboxIE);

var _flexboxOld = __webpack_require__(61);
...
var _prefixProps = __webpack_require__(19);
...
var _bowser = __webpack_require__(47);
...
!function (root, name, definition) {
  ...
  else if (true) __webpack_require__(48)(name, definition)
...
var _styleSheet = __webpack_require__(75);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18), __webpack_require__(78)(module)))
